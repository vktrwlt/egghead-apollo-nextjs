...
const CREATE_PRODUCT = gql`
  mutation CreateProduct($name: String!, $description: String!, $imageUrl: String!, $category: String!, $price: Float!, $shopID: ID!) {
    createProduct(
      data: { name: $name, description: $description, imageUrl: $imageUrl, category: $category, price: $price, shop: { connect: $shopID } }
    ) {
      _id
      name
    }
...
const ProductForm = (props: any) => {
  ...
  return (
    <div className="pt-5 pb-5 pl-20 pr-20">
      <h1 className="mb-1 text-lg">Create a new Product</h1>
